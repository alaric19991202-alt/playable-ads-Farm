...
export function createPlacementSystem({
  ...
  let activeBlueprint = null; // { mesh, itemDef, cloneFn }
  let placed = [];
  let selected = null;
  ...
  function updateBlueprintPosition(clientX, clientY) {
    ...
    // float a bit like Garden Joy's preview
  ...
  function pickPlaced(clientX, clientY) {
    ...
    let o = hits[0].object;
    while (o && !placed.includes(o)) o = o.parent;
    selected = o || null;
    return selected;
  }
